...
public abstract class FragmentTransaction {
    ...
    int mExitAnim;
    String mName;
    ArrayList<C0240Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0240Op {
        ...
        C0240Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0240Op(int i, Fragment fragment, State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0240Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0240Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0240Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0240Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0240Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0240Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, State state) {
        addOp(new C0240Op(10, fragment, state));
        return this;
    }
