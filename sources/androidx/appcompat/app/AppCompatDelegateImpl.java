...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0039R.layout.abc_list_menu_item_layout);
        ...
        if (obtainStyledAttributes.hasValue(C0039R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) from.inflate(C0039R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) from.inflate(C0039R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                ...
                viewGroup = (ViewGroup) from.inflate(C0039R.layout.abc_dialog_title_material, null);
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0039R.layout.abc_screen_toolbar, null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0039R.C0041id.decor_content_parent);
            ...
            if (viewGroup != null) {
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0039R.C0041id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0039R.C0041id.action_bar_activity_content);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0039R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0039R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0039R.attr.actionBarSize
        ...
        L_0x00b5:
            ...
            int r4 = androidx.appcompat.C0039R.C0041id.action_mode_bar_stub
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0039R.attr.actionBarTheme, typedValue, true);
            Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0039R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0039R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        view2.setBackgroundColor(this.mContext.getResources().getColor(C0039R.color.abc_input_method_navigation_guard));
