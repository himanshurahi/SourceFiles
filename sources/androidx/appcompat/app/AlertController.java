...
class AlertController {
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0039R.C0041id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0039R.C0041id.topPanel);
        View findViewById3 = findViewById.findViewById(C0039R.C0041id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0039R.C0041id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0039R.C0041id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0039R.C0041id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0039R.C0041id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0039R.C0041id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0039R.C0041id.textSpacerNoButtons);
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0039R.C0041id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            View findViewById9 = resolvePanel2.findViewById(C0039R.C0041id.textSpacerNoTitle);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0039R.C0041id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0039R.C0041id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0039R.C0041id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0039R.C0041id.title_template).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.mWindow.findViewById(C0039R.C0041id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0039R.C0041id.scrollView);
