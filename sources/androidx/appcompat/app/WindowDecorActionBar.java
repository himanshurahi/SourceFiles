...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0039R.C0041id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0039R.C0041id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0039R.C0041id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(C0039R.C0041id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0039R.styleable.ActionBar, C0039R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0039R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0039R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0039R.attr.actionBarWidgetTheme, typedValue, true);
