...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r4, int r5) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0039R.styleable.CompoundButton
            r2 = 0
            android.content.res.TypedArray r4 = r0.obtainStyledAttributes(r4, r1, r5, r2)
            int r5 = androidx.appcompat.C0039R.styleable.CompoundButton_buttonCompat     // Catch:{ all -> 0x0080 }
        ...
        L_0x002f:
            ...
            int r5 = androidx.appcompat.C0039R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x0080 }
            boolean r5 = r4.hasValue(r5)     // Catch:{ all -> 0x0080 }
            if (r5 == 0) goto L_0x0050
            int r5 = androidx.appcompat.C0039R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x0080 }
            int r5 = r4.getResourceId(r5, r2)     // Catch:{ all -> 0x0080 }
        ...
        L_0x0050:
            int r5 = androidx.appcompat.C0039R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x0080 }
            boolean r5 = r4.hasValue(r5)     // Catch:{ all -> 0x0080 }
            if (r5 == 0) goto L_0x0063
            android.widget.CompoundButton r5 = r3.mView     // Catch:{ all -> 0x0080 }
            int r0 = androidx.appcompat.C0039R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x0080 }
        ...
        L_0x0063:
            int r5 = androidx.appcompat.C0039R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x0080 }
            boolean r5 = r4.hasValue(r5)     // Catch:{ all -> 0x0080 }
            if (r5 == 0) goto L_0x007c
            android.widget.CompoundButton r5 = r3.mView     // Catch:{ all -> 0x0080 }
            int r0 = androidx.appcompat.C0039R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x0080 }
            r1 = -1
