...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0039R.layout.abc_tooltip, null);
        this.mContentView = inflate;
        this.mMessageView = (TextView) inflate.findViewById(C0039R.C0041id.message);
        ...
        this.mLayoutParams.windowAnimations = C0039R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0039R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C0039R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C0039R.dimen.tooltip_y_offset_touch : C0039R.dimen.tooltip_y_offset_non_touch);
