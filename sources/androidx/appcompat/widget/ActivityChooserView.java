...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            int itemViewType = getItemViewType(i);
            if (itemViewType == 0) {
                if (view == null || view.getId() != C0039R.C0041id.list_item) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                ((ImageView) view.findViewById(C0039R.C0041id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                ((TextView) view.findViewById(C0039R.C0041id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                if (view == null || view.getId() != 1) {
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    view.setId(1);
                    ((TextView) view.findViewById(C0039R.C0041id.title)).setText(ActivityChooserView.this.getContext().getString(C0039R.string.abc_activity_chooser_view_see_all));
                }
                return view;
            } else {
                throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0039R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        }
        ...
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0039R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        View findViewById = findViewById(C0039R.C0041id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0039R.C0041id.default_activity_button);
        this.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0039R.C0041id.image);
        FrameLayout frameLayout2 = (FrameLayout) findViewById(C0039R.C0041id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(C0039R.C0041id.image);
