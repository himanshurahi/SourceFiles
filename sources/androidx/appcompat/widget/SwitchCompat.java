...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0039R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        Mode parseTintMode2 = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0039R.styleable.SwitchCompat_trackTintMode, -1), null);
