...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0039R.styleable.SearchView_layout, C0039R.layout.abc_search_view), this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0039R.C0041id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0039R.C0041id.search_edit_frame);
        this.mSearchPlate = findViewById(C0039R.C0041id.search_plate);
        this.mSubmitArea = findViewById(C0039R.C0041id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0039R.C0041id.search_button);
        this.mGoButton = (ImageView) findViewById(C0039R.C0041id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0039R.C0041id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0039R.C0041id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0039R.C0041id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0039R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0039R.string.abc_searchview_description_search));
