    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (true) {
            if (i16 <= 0 || i9 <= 0) {
                ...
                int i22 = 0;
                int i23 = 0;
                int i24 = ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
                long j2 = 0;
        ...
        if (z2) {
            for (int i34 = 0; i34 < childCount; i34++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i11) + layoutParams5.extraPixels, 1073741824), childMeasureSpec);
                }
            }
        }
