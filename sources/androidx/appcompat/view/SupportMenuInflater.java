...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (obtainStyledAttributes.getInt(C0039R.styleable.MenuItem_android_menuCategory, this.groupCategory) & SupportMenu.CATEGORY_MASK) | (obtainStyledAttributes.getInt(C0039R.styleable.MenuItem_android_orderInCategory, this.groupOrder) & SupportMenu.USER_MASK);
