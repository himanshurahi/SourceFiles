...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0153R.C0155id.accessibility_custom_action_0, C0153R.C0155id.accessibility_custom_action_1, C0153R.C0155id.accessibility_custom_action_2, C0153R.C0155id.accessibility_custom_action_3, C0153R.C0155id.accessibility_custom_action_4, C0153R.C0155id.accessibility_custom_action_5, C0153R.C0155id.accessibility_custom_action_6, C0153R.C0155id.accessibility_custom_action_7, C0153R.C0155id.accessibility_custom_action_8, C0153R.C0155id.accessibility_custom_action_9, C0153R.C0155id.accessibility_custom_action_10, C0153R.C0155id.accessibility_custom_action_11, C0153R.C0155id.accessibility_custom_action_12, C0153R.C0155id.accessibility_custom_action_13, C0153R.C0155id.accessibility_custom_action_14, C0153R.C0155id.accessibility_custom_action_15, C0153R.C0155id.accessibility_custom_action_16, C0153R.C0155id.accessibility_custom_action_17, C0153R.C0155id.accessibility_custom_action_18, C0153R.C0155id.accessibility_custom_action_19, C0153R.C0155id.accessibility_custom_action_20, C0153R.C0155id.accessibility_custom_action_21, C0153R.C0155id.accessibility_custom_action_22, C0153R.C0155id.accessibility_custom_action_23, C0153R.C0155id.accessibility_custom_action_24, C0153R.C0155id.accessibility_custom_action_25, C0153R.C0155id.accessibility_custom_action_26, C0153R.C0155id.accessibility_custom_action_27, C0153R.C0155id.accessibility_custom_action_28, C0153R.C0155id.accessibility_custom_action_29, C0153R.C0155id.accessibility_custom_action_30, C0153R.C0155id.accessibility_custom_action_31};
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m4at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0153R.C0155id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0153R.C0155id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        private boolean onUnhandledKeyEvent(View view, KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0153R.C0155id.tag_unhandled_key_listeners);
            if (arrayList != null) {
    ...
    private static List<AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0153R.C0155id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0153R.C0155id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    public static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0153R.C0155id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                view.setTag(C0153R.C0155id.tag_unhandled_key_listeners, map);
            }
            C01912 r1 = new OnUnhandledKeyEventListener() {
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0153R.C0155id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0153R.C0155id.tag_screen_reader_focusable, Boolean.class, 28) {
            /* access modifiers changed from: 0000 */
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0153R.C0155id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: 0000 */
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0153R.C0155id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: 0000 */
            public Boolean frameworkGet(View view) {
