    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next != 2 || depth2 > depth || !xmlPullParser.getName().equals("item")) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet2, C0153R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0153R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0153R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0153R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0153R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0153R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0153R.attr.alpha)) {
                        int i5 = i3 + 1;
