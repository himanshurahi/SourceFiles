    ...
    public static class PathDataNode {
            ...
            while (i3 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        float f38 = f18;
                        float f39 = f17;
                        drawArc(path, f17, f18, f32, f33, f34, f35, f37, z, z2);
                        f = f39 + fArr3[i44];
                        f2 = f38 + fArr3[i45];
                    }
                    i3 = i2 + i;
        ...
        private static void arcToBezier(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                double d32 = cos;
                double d33 = d24 + (d21 * sin4);
                double d34 = sin;
                double d35 = d26 - (sin4 * d28);
                double d36 = d19;
                double d37 = d27 - (sin4 * d29);
                double d38 = d15;
                path.rLineTo(0.0f, 0.0f);
                path.cubicTo((float) d31, (float) d33, (float) d35, (float) d37, (float) d26, (float) d27);
                i++;
                d19 = d36;
                sin = d34;
                d23 = d26;
