...
public class ConstraintLayout extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        private static class Table {
            ...
            static {
                ...
                map = sparseIntArray;
                sparseIntArray.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintCircle, 2);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                map.append(C0146R.styleable.ConstraintLayout_Layout_android_orientation, 1);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                map.append(C0146R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
            }
        }
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0146R.styleable.ConstraintLayout_Layout);
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0146R.styleable.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0146R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.mMinWidth = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMinWidth);
                } else if (index == C0146R.styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.mMinHeight = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMinHeight);
                } else if (index == C0146R.styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.mMaxWidth = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxWidth);
                } else if (index == C0146R.styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.mMaxHeight = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxHeight);
                } else if (index == C0146R.styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.mOptimizationLevel = obtainStyledAttributes.getInt(index, this.mOptimizationLevel);
                } else if (index == C0146R.styleable.ConstraintLayout_Layout_constraintSet) {
                    ...
                    if (layoutParams.circleConstraint != -1) {
                        ...
                        if (layoutParams.baselineToBaseline != -1) {
                            ...
                            if (!(targetWidget10 == null || view == null || !(view.getLayoutParams() instanceof LayoutParams))) {
                                ...
                                viewWidget2.getAnchor(Type.BASELINE).connect(targetWidget10.getAnchor(Type.BASELINE), 0, -1, Strength.STRONG, 0, USE_CONSTRAINTS_HELPER);
