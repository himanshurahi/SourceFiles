...
import androidx.constraintlayout.widget.C0146R.C0147id;
...
public class ConstraintSet {
    ...
    static {
        ...
        sparseIntArray.append(C0146R.styleable.ConstraintSet_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_editor_absoluteX, 6);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_editor_absoluteY, 7);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintGuide_end, 18);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_orientation, 27);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_goneMarginLeft, 13);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_goneMarginTop, 16);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_goneMarginRight, 14);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_goneMarginBottom, 11);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_goneMarginStart, 15);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_goneMarginEnd, 12);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_marginLeft, 24);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_marginRight, 28);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_marginStart, 31);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_marginEnd, 8);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_marginTop, 34);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_marginBottom, 2);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_width, 23);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_layout_height, 21);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_visibility, 22);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_alpha, 43);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_elevation, 44);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_rotationX, 45);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_rotationY, 46);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_rotation, 60);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_scaleX, 47);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_scaleY, 48);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_transformPivotX, 49);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_transformPivotY, 50);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_translationX, 51);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_translationY, 52);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_translationZ, 53);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintWidth_default, 54);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHeight_default, 55);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintWidth_max, 56);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHeight_max, 57);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintWidth_min, 58);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHeight_min, 59);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintCircle, 61);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0146R.styleable.ConstraintSet_android_id, 38);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0146R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0146R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0146R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0146R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0146R.styleable.ConstraintSet);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0147id.class.getField(trim).getInt(null);
