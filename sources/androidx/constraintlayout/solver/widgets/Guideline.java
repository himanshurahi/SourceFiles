...
public class Guideline extends ConstraintWidget {
    ...
    static /* synthetic */ class C01441 {
        ...
        static {
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.Guideline.C01441.<clinit>():void");
        }
    }
    ...
    public ConstraintAnchor getAnchor(Type type) {
        switch (C01441.f19x4c44d048[type.ordinal()]) {
            case 1:
            case 2:
                if (this.mOrientation == 1) {
                    return this.mAnchor;
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidgetContainer != null) {
            ...
            boolean z = true;
            boolean z2 = this.mParent != null && this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            if (this.mOrientation == 0) {
