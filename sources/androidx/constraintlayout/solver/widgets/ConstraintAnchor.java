...
public class ConstraintAnchor {
    ...
    static /* synthetic */ class C01421 {
        ...
        static {
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.ConstraintAnchor.C01421.<clinit>():void");
        }
    }
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        if (type != type2) {
            switch (C01421.f14x4c44d048[this.mType.ordinal()]) {
                case 1:
    ...
    public boolean isSnapCompatibleWith(ConstraintAnchor constraintAnchor) {
        ...
        switch (C01421.f14x4c44d048[this.mType.ordinal()]) {
            ...
            case 9:
                return false;
            case 2:
                int i = C01421.f14x4c44d048[constraintAnchor.getType().ordinal()];
                if (i == 3 || i == 7) {
                    return true;
                }
                return false;
            case 3:
                int i2 = C01421.f14x4c44d048[constraintAnchor.getType().ordinal()];
                if (i2 == 2 || i2 == 7) {
                    return true;
                }
                return false;
            case 4:
                int i3 = C01421.f14x4c44d048[constraintAnchor.getType().ordinal()];
                if (i3 == 5 || i3 == 8) {
                    return true;
                }
                return false;
            case 5:
                int i4 = C01421.f14x4c44d048[constraintAnchor.getType().ordinal()];
                if (i4 == 4 || i4 == 8) {
                    return true;
                }
                return false;
            case 7:
                int i5 = C01421.f14x4c44d048[constraintAnchor.getType().ordinal()];
                if (i5 == 2 || i5 == 3) {
                    return true;
                }
                return false;
            case 8:
                int i6 = C01421.f14x4c44d048[constraintAnchor.getType().ordinal()];
                if (i6 == 4 || i6 == 5) {
                    return true;
                }
                return false;
