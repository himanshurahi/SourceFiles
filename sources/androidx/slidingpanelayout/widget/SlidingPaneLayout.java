        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = MeasureSpec.makeMeasureSpec(paddingLeft - i15, 1073741824);
                } else {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i6 = i16;
                                    int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i18, 1073741824);
                                    if (i7 != i18) {
                                    ...
                                    i6 = i16;
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i13))) / f)), 1073741824), i8);
                                    i17++;
                                    i16 = i6;
                                    i5 = 8;
                                }
