...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C02811 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C02811.<clinit>():void");
        }
    }
    ...
    static State getStateAfter(Event event) {
        switch (C02811.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
    ...
    private static Event downEvent(State state) {
        int i = C02811.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
