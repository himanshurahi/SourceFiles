...
import androidx.gridlayout.C0254R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0254R.styleable.GridLayout_alignmentMode;
    ...
    private static final int COLUMN_COUNT = C0254R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0254R.styleable.GridLayout_columnOrderPreserved;
    ...
    private static final int ORIENTATION = C0254R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0254R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0254R.styleable.GridLayout_rowOrderPreserved;
    ...
    private static final int USE_DEFAULT_MARGINS = C0254R.styleable.GridLayout_useDefaultMargins;
    ...
    static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m8of(Class<K> cls, Class<V> cls2) {
    ...
    final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc of = Assoc.m8of(Spec.class, Bounds.class);
            int childCount = GridLayout.this.getChildCount();
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc of = Assoc.m8of(Interval.class, MutableInt.class);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0254R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0254R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0254R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0254R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0254R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0254R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0254R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0254R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0254R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0254R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0254R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0254R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0254R.styleable.GridLayout_Layout);
            try {
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0254R.dimen.default_gap);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0254R.styleable.GridLayout);
        try {
    ...
    private int getDefaultMargin(View view, LayoutParams layoutParams, boolean z, boolean z2) {
        ...
        boolean z4 = (!z || !isLayoutRtlCompat()) ? z2 : !z2 ? DEFAULT_ORDER_PRESERVED : false;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i7 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int i15 = measurement;
                View view = childAt;
                int offset = bounds3.getOffset(this, childAt, alignment3, measurement + i13, DEFAULT_ORDER_PRESERVED);
                int i16 = i14;
                View view2 = view;
                iArr = locations2;
                int i17 = i16;
    ...
    public static Spec spec(int i, int i2, Alignment alignment, float f) {
        Spec spec = new Spec(i != Integer.MIN_VALUE ? DEFAULT_ORDER_PRESERVED : false, i, i2, alignment, f);
        return spec;
    }
